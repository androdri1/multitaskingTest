...
Script: qof_domain_builders/02a04_build_qof_practice_mental_health.do
Language: Stata
Purpose: Recovered raw-to-Stata QOF domain builder.
Recovered original script: data/GPs/_sources/1.QoF_dos/QOF_01-GPprac-Mental.do
Main output(s): QOFmental-practicePanel.dta
...
preserve
clear
import excel "2006/qof-eng-06-07-prac-tabs-clin-dom-ment-heal.xls", allstring sheet("Sheet1") cellrange(A5:U8376) //firstrow
...
rename F MH08Points
rename G MH04Numerator
rename H MH04Denominator
rename I MH04Points
rename J MH05Numerator
rename K MH05Denominator
rename L MH05Points
rename M MH06Numerator
rename N MH06Denominator
rename O MH06Points
rename P MH07Numerator
rename Q MH07Denominator
rename R MH07Points
rename S MH09Numerator
rename T MH09Denominator
rename U MH09Points
...
preserve
clear
import excel "2007/qof-eng-07-08-prac-tabs-clin-dom-ment-heal.xls", allstring sheet("Sheet1") cellrange(A14:U8307) //firstrow
...
preserve
clear
import excel "2008/qof-eng-08-09-prac-tabs-clin-dom-ment-heal.xls", allstring sheet("QOF export") cellrange(A15:AA8243) //firstrow
...
rename G MH08Points
rename H MH04Points
rename I MH04Numerator
rename J MH04Denominator
rename K MH04Achievement
rename L MH05Points
rename M MH05Numerator
rename N MH05Denominator
rename O MH05Achievement
rename P MH06Points
rename Q MH06Numerator
rename R MH06Denominator
rename S MH06Achievement
rename T MH07Points
rename U MH07Numerator
rename V MH07Denominator
rename W MH07Achievement
rename X MH09Points
rename Y MH09Numerator
rename Z MH09Denominator
rename AA MH09Achievement
...
preserve
clear
import excel "2009/qof-09-10-data-tab-prac-clin-ment.xls", allstring sheet("QOF export") cellrange(A15:AA8319) //firstrow
...
preserve
clear
import excel "2010/qof-10-11-data-tab-prac-clin-ment.xls", allstring sheet("QOF export") cellrange(A15:AA8259) //firstrow
...
clear
import excel "2011/QOF-11-12-data-tabs-pracs-men-heal.xls", allstring sheet("MH08") cellrange(A15:G8137) //firstrow
...
foreach indi in "10" "11" "12" "13" "14" "15" "16" "17" "18" {

	clear
	import excel "2011/QOF-11-12-data-tabs-pracs-men-heal.xls", allstring sheet("MH`indi'") cellrange(A15:N8137) //firstrow
	...
	rename G MH`indi'Points
	rename H MH`indi'Numerator
	rename I MH`indi'Denominator
	rename J MH`indi'Achievement
	rename K MH`indi'Exceptions
	rename L MH`indi'ExceptionRate
	rename M MH`indi'DenominatorPE
	rename N MH`indi'AchievementPE
...
destring  year- MH10AchievementPE, replace force
...
save "QOFmental-practicePanel.dta", replace
