...
Script: qof_domain_builders/02a06_build_qof_practice_chd.do
Language: Stata
Purpose: Recovered raw-to-Stata QOF domain builder.
Recovered original script: data/GPs/_sources/1.QoF_dos/QOF_01-GPprac-coron.do
Main output(s): QOFcoron-practicePanel.dta
...
preserve
clear
import excel "2006/qof-eng-06-07-prac-tabs-clin-dom-coro-hd.xls", allstring sheet("Sheet1") cellrange(A5:AG8376) //firstrow
...
rename F CHD01Points
rename G CHD02Numerator
rename H CHD02Denominator
rename I CHD02Points
rename J CHD05Numerator
rename K CHD05Denominator
rename L CHD05Points
rename M CHD06Numerator
rename N CHD06Denominator
rename O CHD06Points
rename P CHD07Numerator
rename Q CHD07Denominator
rename R CHD07Points
rename S CHD08Numerator
rename T CHD08Denominator
rename U CHD08Points
rename V CHD09Numerator
rename W CHD09Denominator
rename X CHD09Points
rename Y CHD10Numerator
rename Z CHD10Denominator
rename AA CHD10Points
rename AB CHD11Numerator
rename AC CHD011Denominator
rename AD CHD11Points
rename AE CHD12Numerator
rename AF CHD12Denominator
rename AG CHD12Points
...
preserve
clear
import excel "2007/qof-eng-07-08-prac-tabs-clin-dom-coro-hd.xls", allstring sheet("Sheet1") cellrange(A14:AG8307) //firstrow
...
preserve
clear
import excel "2008/qof-eng-08-09-prac-tabs-clin-dom-coro-hd.xls", allstring sheet("QOF export") cellrange(A15:AQ8243) //firstrow
...
rename G CHD01Points
rename H CHD02Points
rename I CHD02Numerator
rename J CHD02Denominator
rename K CHD02Achievement
rename L CHD05Points
rename M CHD05Numerator
rename N CHD05Denominator
rename O CHD05Achievement
rename P CHD06Points
rename Q CHD06Numerator
rename R CHD06Denominator
rename S CHD06Achievement
rename T CHD07Points
rename U CHD07Numerator
rename V CHD07Denominator
rename W CHD07Achievement
rename X CHD08Points
rename Y CHD08Numerator
rename Z CHD08Denominator
rename AA CHD08Achievement
rename AB CHD09Points
rename AC CHD09Numerator
rename AD CHD09Denominator
rename AE CHD09Achievement
rename AF CHD10Points
rename AG CHD10Numerator
rename AH CHD10Denominator
rename AI CHD10Achievement
rename AJ CHD11Points
rename AK CHD11Numerator
rename AL CHD11Denominator
rename AM CHD11Achievement
rename AN CHD12Points
rename AO CHD12Numerator
rename AP CHD12Denominator
rename AQ CHD12Achievement
...
preserve
clear
import excel "2009/qof-09-10-data-tab-prac-clin-coro.xls", allstring sheet("QOF export") cellrange(A15:AQ8319) //firstrow
...
preserve
clear
import excel "2010/qof-10-11-data-tab-prac-clin-coro.xls", allstring sheet("QOF export") cellrange(A15:AQ8259) //firstrow
...
clear
import excel "2011/QOF-11-12-data-tab-pracs-con-hea-dis.xls", allstring sheet("CHD01") cellrange(A15:G8137) //firstrow
...
foreach indi in "06" "08" "09" "10" "12" "13" "14" {

	clear
	import excel "2011/QOF-11-12-data-tab-pracs-con-hea-dis.xls", allstring sheet("CHD`indi'") cellrange(A15:N8137) //firstrow
	...
	rename G CHD`indi'Points
	rename H CHD`indi'Numerator
	rename I CHD`indi'Denominator
	rename J CHD`indi'Achievement
	rename K CHD`indi'Exceptions
	rename L CHD`indi'ExceptionRate
	rename M CHD`indi'DenominatorPE
	rename N CHD`indi'AchievementPE
...
destring  year- CHD06AchievementPE, replace force
...
label data "Quality of Output Framework (GP) Coronary Heart Disease Data by practice"

drop pra_name

save "QOFcoron-practicePanel.dta", replace
