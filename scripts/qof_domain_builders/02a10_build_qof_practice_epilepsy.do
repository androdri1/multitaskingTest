...
Script: qof_domain_builders/02a10_build_qof_practice_epilepsy.do
Language: Stata
Purpose: Recovered raw-to-Stata QOF domain builder.
Recovered original script: data/GPs/_sources/1.QoF_dos/QOF_01-GPprac-epil.do
Main output(s): QOFepil-practicePanel.dta
...
preserve
clear
import excel "2009/qof-09-10-data-tab-prac-clin-epil.xls", allstring sheet("QOF export") cellrange(A15:S8319) //firstrow
...
rename G EPILEP05Points
rename H EPILEP06Points
rename I EPILEP06Numerator
rename J EPILEP06Denominator
rename K EPILEP06Achievement
rename L EPILEP07Points
rename M EPILEP07Numerator
rename N EPILEP07Denominator
rename O EPILEP07Achievement
rename P EPILEP08Points
rename Q EPILEP08Numerator
rename R EPILEP08Denominator
rename S EPILEP08Achievement
...
preserve
clear
import excel "2010/qof-10-11-data-tab-prac-clin-epil.xls", allstring sheet("QOF export") cellrange(A15:S8259) //firstrow
...
clear
import excel "2011/QOF-11-12-data-tab-pracs-epil.xls", allstring sheet("EPILEP05") cellrange(A15:G8137) //firstrow
...
foreach indi in "06" "08" "09" {

	clear
	import excel "2011/QOF-11-12-data-tab-pracs-epil.xls", allstring sheet("EPILEP`indi'") cellrange(A15:N8137) //firstrow
	...
	rename G EPILEP`indi'Points
	rename H EPILEP`indi'Numerator
	rename I EPILEP`indi'Denominator
	rename J EPILEP`indi'Achievement
	rename K EPILEP`indi'Exceptions
	rename L EPILEP`indi'ExceptionRate
	rename M EPILEP`indi'DenominatorPE
	rename N EPILEP`indi'AchievementPE
...
destring  year- EPILEP06AchievementPE, replace force
...
label data "Quality of Output Framework (GP) Epilepsy Data by practice"

drop pra_name

save "QOFepil-practicePanel.dta", replace
